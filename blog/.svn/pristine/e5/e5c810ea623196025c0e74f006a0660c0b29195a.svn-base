...
<body>
	...
	<s:form action="" namespace="/friendspage">
		<!-- 源码 -->
		<div id="header">
			<div id="headerTop">
            ...
            <li><a href="<%=path%>/friends/friends.jsp" class="over">博 友</a></li>
		...
		<div id="left">
			...
			<s:iterator value="flist">
				<div class="ListItem">
					...
					<ul class="ulBox">
						<li><img class="friendphoto"
							src="<%=path%>/images/friendlogo.gif" alt="博友头像" />
							<div>		
								<strong><a href="#">姓名:<s:property value="friend.nickName"  /></a></strong> <span>年龄：<s:property value="friend."  /></span> <span>所在地：河北
									唐山</span> <span>最后登录：<s:property value="friend."  /></span>
							</div> <a href="#" class="comm">发送消息</a> <a href="#" class="comm">删除</a>
						</li>
		...
		<div id="footer">&copy; Copyright 2010. All rights shinowIT.com
		</div>
	</s:form>
</body>
</html>
