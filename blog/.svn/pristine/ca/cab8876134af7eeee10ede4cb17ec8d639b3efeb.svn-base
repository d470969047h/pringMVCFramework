...
<div id="header">
    ...
    <div id="mainMenu">
        ...
        <ul>
            ...
            <li><a href="<%=path%>/photoAlbum/photoAlbum.jsp" class="over">相 册</a></li>
...
<div id="left">
	<div class="ListItem">
        ...
        <div class="photoContent">
			<p>
            	<img class="photoS" src="<%=path%>/images/photoLogo.gif" name="gjs" alt="相册封面" />
                <img class="photoS" src="<%=path%>/images/photoLogo2.gif" name="bed" alt="相册封面" />
                <img class="photoS" src="<%=path%>/images/photoLogo3.gif" name="za" alt="相册封面" />
                <img class="photoS" src="<%=path%>/images/photoLogo.gif" name="gjs" alt="相册封面" />
                <img class="photoS" src="<%=path%>/images/photoLogo2.gif" name="bed" alt="相册封面" />
                <img class="photoS" src="<%=path%>/images/photoLogo3.gif" name="za" alt="相册封面" />
                <img class="photoS" src="<%=path%>/images/photoLogo.gif" name="gjs" alt="相册封面" />
            ...
            <p>
            	<img id="photoShow" src="<%=path%>/images/gjs.gif" alt="世界凶犬" />
            </p>
            <p>世界凶犬</p>
